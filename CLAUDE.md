...
**Active workstreams**
1. **Groq migration (deadline Aug 16, 2026)** — swap to `openai/gpt-oss-120b` / `openai/gpt-oss-20b`; open question: inline literals vs. centralizing into named constants (§2b.2 says centralize); re-test Scenario Builder structured output.
